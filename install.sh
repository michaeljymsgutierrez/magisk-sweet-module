...
ui_print " "
  ...
  ui_print "- 【🔥Fast Charge⚡Version Green🍀】 "
...
ui_print "   5. ⚡4300mA / 25.6W⚡"
ui_print "   6. ⚡4500mA / 27W⚡"
ui_print "   7. ⚡5000mA / 30W⚡"
ui_print "   "
ui_print "  Select:"
FC=1
while true; do
...
case $FC in
	...
	5 ) FASTCHARGEMODE="4300";;
	6 ) FASTCHARGEMODE="4500";;
	7 ) FASTCHARGEMODE="5000";;
esac

ui_print "   "
ui_print "  Fast Charge: $FASTCHARGEMODE mA "
ui_print "   "
...
ui_print "#######################################"
ui_print " "
ui_print "--> Fast Charge has been installed successfully!"
ui_print " "
ui_print "--> If you have any bug please report to"
ui_print " "
ui_print "--> @NTH_MI9 on telegram"
ui_print " "
ui_print "--> Group: @Mi9Mod"
ui_print " "
ui_print "--> Channel: @ModByNTH"
ui_print " "
ui_print "#######################################"
  }
